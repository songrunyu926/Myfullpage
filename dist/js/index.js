...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var __WEBPACK_IMPORTED_MODULE_0__business_access_access__ = __webpack_require__(1);
  ...
  __webpack_exports__["a"] = index => {
    ...
    const cList = document.querySelector('#content .list'); //在每次点击导航和小圆点时 同步index

    content.index = index; //切换按钮样式 和 小圆点样式
    ...
    pointNodes[index].classList.add('active'); //同步小箭头

    arrow.style.left = liNodes[index].offsetLeft + liNodes[index].offsetWidth / 2 - arrow.offsetWidth / 2 + 'px'; //竖向滑动

    cList.style.top = -index * content.offsetHeight + 'px'; //开启入场动画

    if (__WEBPACK_IMPORTED_MODULE_0__business_access_access__["a"
    /* default */
    ][index] && typeof __WEBPACK_IMPORTED_MODULE_0__business_access_access__["a"
    /* default */
    ][index]['infn'] === 'function') {
      __WEBPACK_IMPORTED_MODULE_0__business_access_access__["a"
      /* default */
      ][index]['infn']();
    } //开启出场动画
    ...
    if (__WEBPACK_IMPORTED_MODULE_0__business_access_access__["a"
    /* default */
    ][content.preindex] && typeof __WEBPACK_IMPORTED_MODULE_0__business_access_access__["a"
    /* default */
    ][content.preindex]['infn'] === 'function' && index !== content.preindex) {
      __WEBPACK_IMPORTED_MODULE_0__business_access_access__["a"
      /* default */
      ][content.preindex]['outfn']();
    }
  };
  /***/
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var __WEBPACK_IMPORTED_MODULE_0__frame_frame__ = __webpack_require__(3);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_1__business_home__ = __webpack_require__(5);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_2__business_course__ = __webpack_require__(6);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_2__business_course___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__business_course__);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_3__business_works__ = __webpack_require__(7);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_3__business_works___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__business_works__);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_4__business_about__ = __webpack_require__(8);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_5__business_team__ = __webpack_require__(9);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_6__business_access_access__ = __webpack_require__(1);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_7__music_music__ = __webpack_require__(11);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_8__open_open__ = __webpack_require__(12);

  Object(__WEBPACK_IMPORTED_MODULE_8__open_open__["a"
  /* default */
  ])();

  window.onload = () => {
    Object(__WEBPACK_IMPORTED_MODULE_0__frame_frame__["a"
    /* default */
    ])();
    Object(__WEBPACK_IMPORTED_MODULE_1__business_home__["a"
    /* default */
    ])();
    Object(__WEBPACK_IMPORTED_MODULE_5__business_team__["a"
    /* default */
    ])();
    Object(__WEBPACK_IMPORTED_MODULE_4__business_about__["a"
    /* default */
    ])();
    Object(__WEBPACK_IMPORTED_MODULE_7__music_music__["a"
    /* default */
    ])();

    for (let i = 0; i < __WEBPACK_IMPORTED_MODULE_6__business_access_access__["a"
    /* default */
    ].length; i++) {
      __WEBPACK_IMPORTED_MODULE_6__business_access_access__["a"
      /* default */
      ][i]['outfn']();
    }

    setTimeout(() => __WEBPACK_IMPORTED_MODULE_6__business_access_access__["a"
    /* default */
    ][0]['infn'](), 1500);
  };
  /***/
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var __WEBPACK_IMPORTED_MODULE_0__move_move__ = __webpack_require__(0);
  /* harmony import */


  var __WEBPACK_IMPORTED_MODULE_1__wheel_wheel__ = __webpack_require__(4);
  /* harmony default export */
  ...
  __webpack_exports__["a"] = () => {
    ...
    const pointNodes = document.querySelectorAll('#content .points>li'); //初始化小尖角的位置和第一个nav的颜色  

    arrow.style.left = firstLiNode.offsetLeft + firstLiNode.offsetWidth / 2 - arrow.offsetWidth / 2 + 'px';
    firstupNode.style.width = '100%';
    content.preindex = 0; //移动小尖角的位置  点击nav切换颜色 小圆点切换 
    ...
    if (liNodes.length === pointNodes.length) {
      for (var i = 0; i < liNodes.length; i++) {
        ...
        liNodes[i].onclick = pointNodes[i].onclick = function () {
          Object(__WEBPACK_IMPORTED_MODULE_0__move_move__["a"
          /* default */
          ])(this.index);
    ...
    cLiNodes.forEach(liNode => liNode.style.height = content.offsetHeight + 'px'); //滚轮事件
    ...
    if (content.addEventListener) {
      content.addEventListener('DOMMouseScroll', event => {
        clearTimeout(timer);
        timer = setTimeout(() => Object(__WEBPACK_IMPORTED_MODULE_1__wheel_wheel__["a"
        /* default */
        ])(event, content.index), 30);
      });
    }
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  __webpack_exports__["a"] = function () {
    //获取元素
    //内容li
    const homeliNodes = document.querySelectorAll('#content .home > div .home1 li'); //小圆点li

    const homepoints = document.querySelectorAll('#content .home > div .home2 li'); //鼠标移入停止

    const home1 = document.querySelector('#content .list .home .home1');
    let oldindex = 0;
    let timer = 0;
    let autoindex = 0; //点击小圆点切换
    ...
    function home() {
      for (let i = 0; i < homepoints.length; i++) {
        ...
        homepoints[i].onclick = function () {
          ...
          homepoints[this.index].classList.add('active'); //轮播图按照小点移动
          //从左到右
    ...
    function getauto() {
      ...
      timer = setInterval(() => {
        ...
        homeliNodes[oldindex].classList.remove('rightshow');
        homeliNodes[oldindex].classList.remove('righthide');
        homeliNodes[oldindex].classList.remove('leftshow'); //小圆点移动

        for (let i = 0; i < homepoints.length; i++) {
          homepoints[i].classList.remove('active');
        }

        homepoints[autoindex].classList.add('active'); //改变oldindex

        oldindex = autoindex;
      }, 2000);
    }

    setTimeout(getauto, 500); //移入关闭定时器 移出开启定时器
  ...
  __webpack_exports__["a"] = () => {
    ...
    function change(ul) {
      ...
      for (let i = 0; i < 4; i++) {
        ...
        imgNode.src = ul.dataset.src; //分组算法技巧 
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var __WEBPACK_IMPORTED_MODULE_0__qipao_qipao__ = __webpack_require__(10);
  /* harmony default export */
  ...
  __webpack_exports__["a"] = () => {
    ...
    liNodes.forEach(liNode => {
      liNode.onmouseenter = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_0__qipao_qipao__["a"
        /* default */
        ].qipaoFn(qipao);
      };
    });
    ...
    team3.onmouseleave = function () {
      ...
      clearInterval(__WEBPACK_IMPORTED_MODULE_0__qipao_qipao__["a"
      /* default */
      ].interval.timer1);
      clearInterval(__WEBPACK_IMPORTED_MODULE_0__qipao_qipao__["a"
      /* default */
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  __webpack_exports__["a"] = () => {
    ...
    const audio = document.querySelector('#head .headMain .music audio'); //需要加载完毕的图片

    var imgArr = ['bg1.jpg', 'bg2.jpg', 'bg3.jpg', 'bg4.jpg', 'bg5.jpg', 'about1.jpg', 'about2.jpg', 'about3.jpg', 'about4.jpg', 'worksimg1.jpg', 'worksimg2.jpg', 'worksimg3.jpg', 'worksimg4.jpg', 'team.png', 'greenLine.png']; //完成加载的图片数
